...
def get_info(request, username, info):
    if request.user.is_authenticated():
        member = Member.objects.get(user=request.user)
        ...
        follow = 'view-following-list.html'
        followee = 'view-followers-list.html'
        string = ''
...
def get_followees(request, username):
    get_info(request, username, 'followee')


def get_followers(request, username):
    get_info(request, username, 'follower')
